<?php
/*
 * Template Name: Human Illustrations list
...
<div style="margin-top: 300px;" class="stage"> <!-- curtain pull -->
	<div class="wrap"> <!-- start wrap -->
            ...
            <?php query_posts(array('showposts'=> 50,'cat' => 3,'tag' => human, 'post__not_in' => array(311))); if(have_posts()) : while(have_posts()) : the_post(); ?> <!-- starting the WordPress loop -->
